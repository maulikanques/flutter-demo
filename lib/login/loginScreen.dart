...
import 'package:flutter_demo/login/widgets/login_form.dart';
        ...
        body: LayoutBuilder(builder: (context, constraints) {
          return Center(
            child: SingleChildScrollView(
              child: SafeArea(
                  child: Container(
                height: constraints.maxWidth <= 1024
                    ? heightSize(context)
                    : heightSize(context) * 0.65,
                width: constraints.maxWidth <= 1024
                    ? widthSize(context)
                    : widthSize(context) * 0.40,
                child: Card(
                      ...
                      child: Column(children: [
                        Image.asset('assets/images/logo.png',
                            height: constraints.maxWidth <= 1024
                                ...
                                : heightSize(context) * 0.2,
                            width: constraints.maxWidth <= 1024
                                ? widthSize(context) * 0.6
                                : widthSize(context) * 0.15),
                        Visibility(
                        ...
                        constraints.maxWidth <= 1024
                            ? LoginForm(
                                0.007,
                                0.04,
                                widthSize(context) * 0.04,
                                0.06,
                                0.04,
                                0.07,
                                widthSize(context) * 0.09,
                                0.05,
                                0.032,
                                0.04,
                                0.032)
