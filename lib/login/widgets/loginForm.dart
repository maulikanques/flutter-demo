...
class _LoginFormState extends State<LoginForm> {
  ...
  Widget build(BuildContext context) {
    return Padding(
        padding: EdgeInsets.only(left: widthSize(context) * 0.05, right: widthSize(context) * 0.05, top: heightSize(context) * widget.paddingTopForm),
        child: Column(children: <Widget>[
          Align(
              alignment: Alignment.centerLeft,
              child: Text('Username ',
                  style:
                      TextStyle(fontSize: widthSize(context) * widget.fontSizeTextField, fontFamily: Constants.OPEN_MUSEOSANS, color: Colors.white))),
          TextFormField(
              ...
              decoration: InputDecoration(
                ...
                errorText: _userNameValidate ? "Please enter a valid Username !" : null,
                errorStyle: TextStyle(color: Colors.white, fontSize: widthSize(context) * widget.errorFormMessage),
                prefixIcon: Icon(
                  Icons.person,
          ...
          TextFormField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: Colors.white, width: 2)),
                labelStyle: TextStyle(color: Colors.white),
                errorText: _passwordValidate ? "Please enter a valid Password !" : null,
                errorStyle: TextStyle(color: Colors.white, fontSize: widthSize(context) * widget.errorFormMessage),
                prefixIcon: Icon(
                  Icons.lock,
                  size: widthSize(context) * widget.iconFormSize,
              ...
              textAlign: TextAlign.start,
              style: TextStyle(color: Colors.white, fontSize: widget.fontSizeTextFormField)),
          SizedBox(height: heightSize(context) * widget.spaceBetweenFieldAndButton),
          ElevatedButton(
